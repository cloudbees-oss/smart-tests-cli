...
The {PRODUCT} CLI is a Python3 package that you can install from link:https://pypi.org/project/smart-tests-cli/[PyPI].
...
Then run `smart-tests verify` in your CI environment to see if you've successfully configured the CLI. If it succeeds, you'll see a message like the one below. If you see an error message and need more information, refer to xref:administration:troubleshooting.adoc[Troubleshooting].
...
// GENERATED. MODIFY IN CLI SOURCE CODE
|`--include` STR
|Include only files matching pattern (e.g., "*.log"). Can be specified multiple times. (can be specified multiple times)
|No
...
// GENERATED. MODIFY IN CLI SOURCE CODE
|`--component` NAME=BUILDNAME
|Include another build as a named component. Format: NAME=BUILD_OR_ALIAS (can be specified multiple times)
|No

// GENERATED. MODIFY IN CLI SOURCE CODE
|`--include-environment` NAME
|Include all services deployed to this environment as components. See 'record deployment' command.
|No
...
Exactly how this command generates the subset and what's required to do this depends on test runners. For available supported `TESTRUNNER` , see xref:references:integrations.adoc[Integrations]
...
// GENERATED. MODIFY IN CLI SOURCE CODE
|`--bin` INDEX/COUNT
|Split subset into bins, e.g. --bin 1/4
|No
...
// GENERATED. MODIFY IN CLI SOURCE CODE
|`--input-snapshot-id` ID|@FILE
|Reuse reorder results from an existing input snapshot ID or specify @path/to/file to load it
|No
...
|Print the input snapshot ID returned from the server instead of the subset results
|No
...
// GENERATED. MODIFY IN CLI SOURCE CODE
|`--same-bin` FILE
|Keep all tests listed in the file together when splitting; one test per line (can be specified multiple times)
|No
...
// GENERATED. MODIFY IN CLI SOURCE CODE
|`--similarity` CONVERT
|subsetting by similarity from 0 to 1.0. Tests scoring above this value are included in the subset.
|No
...
Exactly how this command generates the subset and what's required to do this depends on test runners. For available supported `TESTRUNNER` s, see xref:references:integrations.adoc[Integrations] .
...
== Command: view flaky-tests

// [generate:view flaky-tests]
`Usage: smart-tests view flaky-tests [OPTIONS]`
...
// GENERATED. MODIFY IN CLI SOURCE CODE
|`--from` DATE
|Start date/time (ISO 8601 format, e.g., '2026-04-08' or '2026-04-08T00:00:00Z')
|No

// GENERATED. MODIFY IN CLI SOURCE CODE
|`--limit` N
|Max results to return per week (default: 50, max: 500)
|No

// GENERATED. MODIFY IN CLI SOURCE CODE
|`--test-path` PATH
|Test path filter (full path string, e.g., 'class=MyTest')
|No

// GENERATED. MODIFY IN CLI SOURCE CODE
|`--to` DATE
|End date/time (ISO 8601 format, e.g., '2026-04-14' or '2026-04-14T23:59:59Z')
|No

// GENERATED. MODIFY IN CLI SOURCE CODE
|`--weeks` N
|Number of weeks to retrieve (default: 1, max: 12)
|No

// GENERATED. MODIFY IN CLI SOURCE CODE
|`--year-week` YYYY-Www
|Specific ISO week for flaky tests (e.g., '2026-W15')
|No

|===
// [/generate]

== Command: view longest-tests

// [generate:view longest-tests]
`Usage: smart-tests view longest-tests [OPTIONS]`
...
// GENERATED. MODIFY IN CLI SOURCE CODE
|`--year-week` YYYY-Www
|Specific ISO week for longest running tests (e.g., '2026-W15')
|No

|===
// [/generate]

== Command: view never-failing-tests

// [generate:view never-failing-tests]
`Usage: smart-tests view never-failing-tests [OPTIONS]`
...
// GENERATED. MODIFY IN CLI SOURCE CODE
|`--year-week` YYYY-Www
|Specific ISO week for never failing tests (e.g., '2026-W15')
|No

|===
// [/generate]

== Command: view test-results

// [generate:view test-results]
`Usage: smart-tests view test-results [OPTIONS]`
...
// GENERATED. MODIFY IN CLI SOURCE CODE
|`--branch` BRANCH
|Filter by branch/lineage (exact match)
|No
...
// GENERATED. MODIFY IN CLI SOURCE CODE
|`--logs`
|Include full stdout/stderr from failed test case executions
|No
...
// GENERATED. MODIFY IN CLI SOURCE CODE
|`--status` STATUS
|Filter by test status (SUCCESS, FAILURE, SKIP, FLAKE)
|No

// GENERATED. MODIFY IN CLI SOURCE CODE
|`--test-path` PATH
|Test path to query results for (required)
|Yes

// GENERATED. MODIFY IN CLI SOURCE CODE
|`--test-suite` NAME
|Filter by test suite name (e.g., 'unit-tests')
|No

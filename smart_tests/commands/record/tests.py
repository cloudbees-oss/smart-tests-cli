...
class RecordTests:
    ...
    def _get_test_session_url(self) -> str:
        ...
        if cbp_workspace:
            ...
            url = f"https://cloudbees.io/{org_cbp_id}/{ws_cbp_id}/smart-tests/test-sessions/{self.test_session_id}"
        else:
            url = (f"https://app.launchableinc.com/organizations/{self.org}/workspaces/"
